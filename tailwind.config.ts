		...
		extend: {
			colors: {
				...
				digital: {
					...
					tertiary: 'hsl(var(--digital-tertiary))',
					success: 'hsl(var(--digital-success))',
					warning: 'hsl(var(--digital-warning))',
					danger: 'hsl(var(--digital-danger))'
				},
				neon: {
			...
			transitionTimingFunction: {
				...
				'digital': 'var(--transition-digital)'
			},
			borderRadius: {
				lg: 'var(--radius)',
